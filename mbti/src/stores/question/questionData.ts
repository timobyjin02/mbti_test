...
export const QuestionData: IQuestionType[] = [
  {
    id: 1,
    title: "새로운 고양이를 데려왔다! 나의 반응은?",
    answera: "머해? 이름은 뭐로 해줄까? 자꾸 말을 걸고 싶다.",
    ansewerb: "혼자만의 시간이 필요하지? 적응할 시간을 준다.",
    type: "EI",
  },
  {
    id: 2,
  ...
  {
    id: 3,
    title: "아무리봐도 우리 고양이가 정말 이쁜 것 같아. 나의 행동은?",
    answera:
      "'고양이 너무 이쁜 것 같아.. 사람들한테 자랑해야지..!!' 하며 인스타를 만들어서 사진도 공유하고 소통도 한다.",
    ansewerb: "우리 고양이 너무 이쁘다.. 사진찍어서 갤러리에 간직한다.",
    type: "EI",
  },
  {
    id: 4,
    ...
    ansewerb: "새롭거나 자유로운 방식으로 만들기 위해 생각한다.",
    type: "SN",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    ansewerb: "칼로리를 정확히 맞춰 저울이나 스푼으로 계량해서 급여한다.",
    type: "SN",
  },
  {
    id: 7,
    ...
    ansewerb: "'아이고,, 어쩌면 좋아..' 일단 먼저 위로를 해준다.",
    type: "IF",
  },
  {
    id: 8,
  ...
  },
  {
    ...
    ansewerb: "사람이 중요하지!! 원장님의 성격이 좋다고 되어있는 병원",
    type: "IF",
  },
  {
    id: 10,
    ...
    answera:
      "우리 고양이 몸무게는 5키로니까 하루세번 몇시에 이만큼 씩 주고, 간식은 이때 챙겨줘야겠다. 영앵제도 미리미리 챙긴다.",
    ansewerb: "사료주면 알아서 먹겠지! 일단 자율급식으로 한꺼번에 줘본다.",
    type: "JP",
  },
  {
    id: 11,
